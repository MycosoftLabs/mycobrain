...
// -------------------------
// BSEC2 constants check
// -------------------------
#ifndef BSEC_INSTANCE_SIZE
  #error "BSEC_INSTANCE_SIZE not defined - check BSEC2 library version"
#endif
...
// FIXED: Proper initialization - Bsec2 objects will be initialized in setup()
...
static void cbENV(const bme68xData data, const bsecOutputs outputs, Bsec2 bsec) {
...
static bool initAll() {
  Wire.end();
  delay(10);  // FIXED: Allow I2C bus to stabilize after end()
...
void setup() {
  ...
  // FIXED: Changed from WS2812B to SK6812 for SK6805 compatibility
  ...
  // FIXED: Properly initialize SensorSlot structs
  S_AMB.name = "AMB";
  S_AMB.addr = 0x77;
  S_ENV.name = "ENV";
  S_ENV.addr = 0x76;
